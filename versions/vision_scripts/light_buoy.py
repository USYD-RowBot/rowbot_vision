...
class LightPattern():
    def __init__(self):
        ...
        self.last_sequence = ["_","_","_"]

    def getPattern(self,image):
        frame = image.copy()
        ...
        if use_simple:
            ...
            for contour in contoursB:
                ...
                if (area > area_lim) & (shape == "rectangle"):
                    ...
                    cv2.putText(blank_image, shape+ str(self.sequence), (cX, cY), cv2.FONT_HERSHEY_SIMPLEX,
                        0.5, (255, 0, 0), 2)

                    colour =  "blue"

                    # Draw the contours onto the object
                    cv2.drawContours(blank_image, contour, -1, (255, 0, 0), 3)
            ...
            for contour in contoursR1:
                ...
                if (area > area_lim) & (shape == "rectangle"):
                    ...
                    # Draw the contours onto the object
                    cv2.drawContours(blank_image, contour, -1, (0, 0, 255), 3)
        ...
        cv2.putText(blank_image, "Sequence: " + str(self.last_sequence), (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)

        return (blank_image,self.last_sequence)
